---
title: oxcのTypeScriptパーサーを読む 第2回 型引数つき呼び出しがASTになるまで
...
次回はいったん高度を上げます。ここまでの2回で歩いた2本の道が、oxcのリポジトリのどのあたりだったのか。ファイルの地図を引いて、TypeScript専用のパーサーというものが存在しないという話をします。
